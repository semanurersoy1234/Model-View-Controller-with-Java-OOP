...
// line 133 "ce204-hw2-Organization-lib.ump"
// line 247 "ce204-hw2-Organization-lib.ump"
public class SurgicalTechnologist extends Technologist
{
  ...
  //------------------------
	/**
	  ...
	  * returns the value
	  **/ 
  public SurgicalTechnologist(String aTitle, String aGivenName, String aMiddleName, String aFamilyName, FullName aName, String aBirthDate, Gender aGender, Address aHomeAddress, Phone aPhone, String aJoined, Department aDepartment)
  {
