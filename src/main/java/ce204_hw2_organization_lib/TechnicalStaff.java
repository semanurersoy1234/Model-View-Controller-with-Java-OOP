...
// line 60 "ce204-hw2-Organization-lib.ump"
// line 176 "ce204-hw2-Organization-lib.ump"
public class TechnicalStaff extends Staff
{
  ...
  //------------------------
	/**
	  ...
	  * returns the value
	  **/
  public TechnicalStaff(String aTitle, String aGivenName, String aMiddleName, String aFamilyName, FullName aName, String aBirthDate, Gender aGender, Address aHomeAddress, Phone aPhone, String aJoined, Department aDepartment)
  {
