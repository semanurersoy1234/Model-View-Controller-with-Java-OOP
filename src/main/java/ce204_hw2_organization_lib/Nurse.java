...
// line 103 "ce204-hw2-Organization-lib.ump"
// line 217 "ce204-hw2-Organization-lib.ump"
public class Nurse extends OperationsStaff
{
  ...
  //------------------------
	/**
	  ...
	  * returns the value
	  **/
  public Nurse(String aTitle, String aGivenName, String aMiddleName, String aFamilyName, FullName aName, String aBirthDate, Gender aGender, Address aHomeAddress, Phone aPhone, String aJoined, Department aDepartment)
  {
