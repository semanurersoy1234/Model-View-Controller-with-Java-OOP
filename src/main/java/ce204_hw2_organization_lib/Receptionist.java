...
// line 128 "ce204-hw2-Organization-lib.ump"
// line 242 "ce204-hw2-Organization-lib.ump"
public class Receptionist extends FrontDeskStaff
{
  ...
  //------------------------
	/**
	  ...
	  * returns the value
	  **/
  public Receptionist(String aTitle, String aGivenName, String aMiddleName, String aFamilyName, FullName aName, String aBirthDate, Gender aGender, Address aHomeAddress, Phone aPhone, String aJoined, Department aDepartment)
  {
